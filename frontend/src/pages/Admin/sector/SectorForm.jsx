  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        />
        {errors.sector_name && (
          <p className="text-delta-negative text-[11px] font-bold ml-1">{errors.sector_name[0]}</p>
        )}
      </div>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className={`w-full px-4 py-3.5 rounded-2xl border bg-muted/50 text-sm font-mono transition-all focus:bg-card focus:outline-none focus:ring-4 ${
            errors.code 
        ...
        />
        {errors.code && (
          <p className="text-delta-negative text-[11px] font-bold ml-1">{errors.code[0]}</p>
        )}
      </div>
      ...
      <div className="space-y-2">
        <label className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-muted-foreground/80 ml-1">
          <University className="w-3.5 h-3.5 text-muted-foreground" />
        ...
        {errors.school_id && (
          <p className="text-delta-negative text-[11px] font-bold ml-1">{errors.school_id[0]}</p>
        )}
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-border/40">
        <Button
          type="submit"
          disabled={isLoading}
          className="flex-[2] bg-primary hover:bg-primary/90 text-primary-foreground rounded-2xl py-7 h-auto shadow-xl shadow-primary/20 transition-all active:scale-[0.98]"
        >
          {isLoading ? (
