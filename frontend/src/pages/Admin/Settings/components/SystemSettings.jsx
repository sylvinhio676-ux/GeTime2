...
export default function SystemSettings({ onDataChange }) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* API Information */}
      <div className="border-t border-gray-200 pt-8 bg-gray-50 rounded-lg p-6">
        ...
        <div className="space-y-2 font-mono text-sm text-gray-700">
          <p>Base URL: <code className="bg-gray-200 px-2 py-1 rounded">http://127.0.0.1:8000/api</code></p>
          <p>Version API: <code className="bg-gray-200 px-2 py-1 rounded">v1</code></p>
          <p>Environnement: <code className="bg-gray-200 px-2 py-1 rounded">Développement</code></p>
        </div>
      </div>
    </div>
  );
