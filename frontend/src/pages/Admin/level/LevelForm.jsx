    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="relative group">
          <input
            ...
            className={`w-full px-4 py-4 rounded-2xl border bg-muted/50 text-sm transition-all focus:bg-card focus:outline-none focus:ring-4 ${
              errors.name_level 
          ...
          {formData.name_level.length > 2 && !errors.name_level && (
            <div className="absolute right-4 top-1/2 -translate-y-1/2 text-delta-positive animate-in zoom-in">
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-4">
        <Button
          type="submit"
          disabled={isLoading}
          className="flex-[2] bg-primary hover:bg-primary/90 text-primary-foreground rounded-2xl py-7 h-auto shadow-xl shadow-primary/20 transition-all active:scale-[0.98] disabled:opacity-70"
        >
          {isLoading ? (
